(function() {
    ...
    function startRedirectButton() {
        ...
        var buttonHtml = '<div id="REDIRECT" class="head__action selector redirect-screen" style="display:inline-block;">' + icon_server_redirect + '</div>';
