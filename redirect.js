(function () {
    ...
    function saveServers(servers) {
        try {
            ...
            console.error("Ошибка сохранения серверов:", e);
        }
    }
    ...
    function updateRedirectButton() {
        $('#REDIRECT').remove();
        let domainBUTT = '<div id="REDIRECT" class="head__action selector redirect-screen" style="position: relative;">' + icon_server_redirect + '</div>';
